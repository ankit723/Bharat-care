...
router.get('/available-prescriptions', authMiddleware_1.authenticate, medStoreController_1.getAvailablePrescriptions);
...
router.post('/:medStoreId/raise-hand/:medDocumentId', authMiddleware_1.authenticate, medStoreController_1.raiseHandForPrescription);
router.delete('/:medStoreId/withdraw-hand/:medDocumentId', authMiddleware_1.authenticate, medStoreController_1.withdrawHandForPrescription);
